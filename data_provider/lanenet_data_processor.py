...
class DataSet(object):
    ...
    def test_data(self,dataset_info_file):
    ...
    def test_next_batch(self, batch_size):
        ...
        for gt_img_path in gt_img_list:
            ...
            gt_name.append(gt_img_path)



        self._next_batch_loop_count += 1
        return gt_imgs, gt_name
    ...
    def next_batch(self, batch_size):
        ...
        if idx_end > len(self._gt_label_binary_list):
            ...
            self._next_batch_loop_count += 1
            return gt_imgs, gt_labels_binary, gt_labels_instance,gt_name


if __name__ == '__main__':
    val = DataSet('/media/wzx/AE5A299C5A2961F7/lanenet-lane-detection-master/data/training_data_example/train.txt')
